...
public class Principal4 {
	...
	public static void main(String[] args) {
		...
		//Objetivo: Vou fazer uma lista de alunos 
		...
		// gerar os alunos com os dados
		for (Aluno aluno1 : listaAlunos) {
			JOptionPane.showMessageDialog(null, "Nome: " + aluno1.getNome() + " Media: " + aluno1.getMediaNota()
					+ " Situação: " + aluno1.getSituacao());
		}
	}

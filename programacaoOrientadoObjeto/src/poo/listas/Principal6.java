...
public class Principal6 {
	...
	public static void main(String[] args) {
		...
		// lista aluno aprovado e reprovado
		List<Aluno> listaAprovados = new ArrayList<Aluno>();
		List<Aluno> listaReprovados = new ArrayList<Aluno>();
